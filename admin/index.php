        ...
        <div class="flex flex-col gap-6 lg:flex-row">
            ...
            <section class="min-w-0 flex-1">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    <div class="admin-card admin-stat rounded-xl bg-white p-5"><p class="text-sm text-slate-500">Total revenue</p><p class="mt-2 text-2xl font-bold text-slate-900">Rs. <?php echo number_format($revenue, 2); ?></p><p class="mt-3 text-xs font-semibold text-emerald-600">Excluding cancelled orders</p></div>
