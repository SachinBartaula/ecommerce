...
function renderOrders() {
    ...
    ordersBody.innerHTML = orders.map(order => {
        ...
        <tr class="transition hover:bg-slate-50">
            ...
            <td class="px-5 py-4 text-right font-semibold text-slate-800">Rs. ${Number(order.total_amount).toFixed(2)}</td>
            <td class="px-5 py-4">
